...
import Gameboard from 'data/tetris/components/Gameboard';
import * as Game from 'data/tetris/models/Game';
import HeldPiece from 'data/tetris/components/HeldPiece';
import PieceQueue from 'data/tetris/components/PieceQueue';
    ...
    return (
        <Context.Provider value={game}>
            {props.children({
                ...
                level,
                controller,
                fillPercentage: game.fillPercentage,
            })}
        </Context.Provider>
    );
}
